...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--alpha", type=float, default=1e-3, help="Attention quadratic coeff [s/tok²]")
    p.add_argument("--beta", type=float, default=1e-4, help="MoE linear coeff [s/tok]")
